                    ...
                    <div>
                        ...
                        <nav aria-label="Page navigation" style="margin: 0 auto; width: 240px">
                            <ul class="pagination" style="margin: 0;">
                                <li>
                                    <a href="<%=path %>/history/retireListPage.do?pageNo=<%=pageInfo.getCurrent()-1>1?pageInfo.getCurrent()-1:1 %>"
                                ...
                                %>
                                <li><a href="<%=path %>/history/retireListPage.do?pageNo=<%=i%>"><%=i %>
                                </a>
                                </li>
                                <%
                                    }
                                %>
                                <li>
                                    <a href="<%=path %>/history/retireListPage.do?pageNo=<%=pageInfo.getCurrent()+1<pageInfo.getPages()?pageInfo.getCurrent()+1:pageInfo.getPages() %>"
